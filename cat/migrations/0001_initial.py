# Generated by Django 5.0.4 on 2024-07-31 21:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maitre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mes_chats', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='FriendRequest',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uploaded_at', models.DateTimeField(auto_now_add=True)),
                ('is_published', models.BooleanField(default=False)),
                ('likes', models.ManyToManyField(blank=True, related_name='videos', to=settings.AUTH_USER_MODEL)),
